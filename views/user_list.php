                ...
                <?php if (!empty($users)) {
                    ...
                    <tr class="text-center">
                        ...
                        <td class="w-1/3 py-3 px-4">
                            <?php echo htmlspecialchars($user->allDataRole->role_name); ?>
                        </td>
                        <td class="w-1/3 py-3 px-4">
                            <?php echo htmlspecialchars($user->allDataRole->role_description); ?>
                        </td>
                        <td class="w-1/6 py-3 px-4">
                            <?php echo htmlspecialchars($user->allDataRole->role_status ? "Active" : "Inactive"); ?>
                        </td>
                        </td>
                        <td class="w-1/6 py-3 px-4">
